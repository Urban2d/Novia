...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = 'Sabia que dirias que si vida mia';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        case 0:
            ...
            document.getElementById('noBtn').style.backgroundColor = '#c0c0c0';
        ...
        case 5:
            ...
            document.getElementById('noBtn').innerHTML = 'Vamos te dare muchos besitos';
            document.getElementById('noBtn').style.backgroundColor = '#c0c0c0';
        ...
        case 10:
            ...
            document.getElementById('noBtn').innerHTML = 'Ya dejaré de preguntar... asi que piensa bien';
            document.getElementById('noBtn').style.backgroundColor = '#c0c0c0';
        ...
        case 12:
            ...
            document.getElementById('noBtn').innerHTML = 'Okey esta es la ultima vez';
            document.getElementById('noBtn').style.backgroundColor = '#c0c0c0';
        ...
        case 15:
            ...
            document.getElementById('noBtn').innerHTML = 'Di Siiiiiiiiiiiiiiiiiiiiiiiiiii';
            document.getElementById('noBtn').style.backgroundColor = '#c0c0c0';
